    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <div className="min-w-full">
          {/* Header */}
          <div className="grid grid-cols-6 gap-4 items-center bg-gray-100 border-b border-gray-200 p-4">
            <div className="text-left text-sm font-semibold text-gray-700">Image</div>
            <div className="text-left text-sm font-semibold text-gray-700">Disease</div>
            <div className="text-left text-sm font-semibold text-gray-700">Case Type</div>
            <div className="text-left text-sm font-semibold text-gray-700">Doctor</div>
            <div className="text-left text-sm font-semibold text-gray-700">Timestamp</div>
            <div className="text-center text-sm font-semibold text-gray-700">Action</div>
          </div>
          {/* Data Rows */}
